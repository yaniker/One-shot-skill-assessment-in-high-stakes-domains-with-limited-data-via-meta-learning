...
def import_feats_SS_JIGSAWS(input_dir: str, feature_no: int, names: list,
                            camera_angle: str, dataset_type: str) -> np.ndarray:
    """
...
def class_name_adjuster(yb: list, new_labels: list) -> np.ndarray:
    """
...
def inp_properties(yb: list, name: str, verbose: bool = False) -> np.ndarray:  
    """
